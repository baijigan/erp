package com.njrsun.common.utils;
...
public class DictUtils
{
    ...
    public static HashMap<String, String> getFormPathCache(String formPath) {
    ...
    public static void setFormPathCache(String formPath, HashMap<String, String> map) {
