 ...
 * @date 2021-11-18
 */
public class PrsPickMaster extends BaseEntity
{
    ...
    /** 生产领料单从信息 */
    private List<PrsPickSalve> prsPickSalveList;
    ...
    public List<PrsPickSalve> getPrsPickSalveList()
    {
        return prsPickSalveList;
    }

    public void setPrsPickSalveList(List<PrsPickSalve> prsPickSalveList)
    {
        this.prsPickSalveList = prsPickSalveList;
    }
    ...
    public String toString() {
        return new ToStringBuilder(this,ToStringStyle.MULTI_LINE_STYLE)
            ...
            .append("prsPickSalveList", getPrsPickSalveList())
            .toString();
    }
}
