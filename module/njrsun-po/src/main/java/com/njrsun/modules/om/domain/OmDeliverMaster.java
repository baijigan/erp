...
/**
 * 销售订单主对象 om_deliver_master
 * 
 * @author njrsun
 * @date 2021-08-31
 */
public class OmDeliverMaster extends BaseEntity
{
    ...
    /** 销售发货从信息 */
    private List<OmDeliverSalve> omDeliverSalveList;
    ...
    public List<OmDeliverSalve> getOmDeliverSalveList()
    {
        return omDeliverSalveList;
    }

    public void setOmDeliverSalveList(List<OmDeliverSalve> omDeliverSalveList)
    {
        this.omDeliverSalveList = omDeliverSalveList;
    }
    ...
    public String toString() {
        return new ToStringBuilder(this,ToStringStyle.MULTI_LINE_STYLE)
            ...
            .append("omDeliverSalveList", getOmDeliverSalveList())
            .toString();
    }
}
