  ...
  <div id="centreLeft1">
    <div class="bg-color-black">
      <div class="d-flex pt-2 pl-2">
        ...
        <div class="d-flex">
          <span class="fs-xl text mx-2">设备运行状态统计</span>
          <dv-decoration-3 style="width:1.25rem;height:.25rem; position:relative;top:-.0375rem;" />
        </div>
      </div>
      <div class="d-flex jc-center" style="display:">
        <CentreLeft1Chart />
      </div>
      <!-- 4个主要的数据 -->
      <div class="bottom-data" style="display:none">
...
<script>
import CentreLeft1Chart from "./echart/centerLeft/centerLeft1Chart";
export default {
  data() {
    return {
      config: {
